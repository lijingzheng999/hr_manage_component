...
public class CheckWorkDetail implements java.io.Serializable {
    ...
    /** 当月多结算天数 */
    @Column(value = "more_settlement_days")
    private BigDecimal moreSettlementDays;
     ...
     * @return 当月多结算天数
     */
    public BigDecimal getMoreSettlementDays() {
        return this.moreSettlementDays;
    }

    /**
     * 设置当月多结算天数
     * 
     * @param moreSettlementDays
     *          当月多结算天数
     */
    public void setMoreSettlementDays(BigDecimal moreSettlementDays) {
        this.moreSettlementDays = moreSettlementDays;
    }
