...
public interface PersonalWorkInfoDAO  extends GenericDAO<PersonalWorkInfo,Integer>{
	...
	public static final String COLUMNS = " id,personal_info_id,working_place,post_type,position,level,department,center,project,expatriate_manager,expatriate_unit,recruit_channel,working_address,contract_count,contract_startdate,contract_enddate,contract_renew_date,contract_renew_enddate,is_leave,leave_working,leave_working_time,is_del,update_time,create_time ";
