		...
		<div class="pad-10">
			...
			<div class="col-tab">
				...
				<div id="div_setting_1" class="contentList pad-10">
					<form id="form" class="form-horizontal" enctype="multipart/form-data" action="/common/saveUploadFile" method="post">
						<div class="control-group">
							<label class="control-label">请选择上传的文件：</label>
							<div class="controls">
							    <input class="" type="test" id="personalInfoId" name="personalInfoId" />
								<input class="" type="file" id="uploadFile" name="uploadFile" />							</div>
						</div>
					</form>
				</div>
				<div class="saveInfo">
